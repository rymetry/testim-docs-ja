...
const CLEAN_PAGE_SLUGS = Object.freeze([
  ...
  // M2 Wave 3 Tier 2 追加 / 2026-04-17 Tricentis legal policy 撤廃後 restore
  //   — EN 原文の "At Testim, we too are developers..." 段落 (`http://testim.io`
  //   リンク含む)、pricing callout (`https://www.testim.io/pricing/`)、changelog
  //   callout を全て JA 側で復活させ、EN 原文に 1:1 追従する通常の zero-drift
  //   sentinel。§5.3.3 `ja_omission_policy_registry` は同日撤廃 (許容機構は
  //   broken-EN snapshot 退避 ONE purpose only に統合)。

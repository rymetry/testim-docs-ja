...
2. env var が無く、かつ **xdist worker** 内なら fail する (silent な N-way
   harness 呼び出しを防ぐ。plan doc の xdist 契約)。
...
def canonical_sha256(value: object) -> str:
    """Python equivalent of ``emit_corpus_oracle.mjs`` ``canonicalSha256``.

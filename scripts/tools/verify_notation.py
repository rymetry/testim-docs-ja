#!/usr/bin/env python3
"""
Verification script for notation consistency after fix_notation.py.
...
DOCS_DIR = Path(__file__).resolve().parent.parent.parent / "src" / "content" / "docs"

# Japanese character ranges — hiragana, katakana, CJK ideographs ONLY.
# Excludes \u3000-\u303f (CJK punctuation: 「」、。（）) to match fix_notation.py.
JP = r'[\u3040-\u309f\u30a0-\u30ff\u4e00-\u9fff]'

...
共有ステップに直接リンク機能は、[共有ステップライブラリ](/docs/test-management/shared-steps-library)から直接共有ステップ/グループへのアクセスを提供します。共有ステップライブラリでテストにアクセスすると、要求されたテストが共有ステップ/グループが選択された状態で表示されます。

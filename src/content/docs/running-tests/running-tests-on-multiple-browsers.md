...
order: 6008
updated: '2025-09-23'
sourceUrl: 'https://docs.tricentis.com/testim/content/running-tests/running-tests-on-multiple-browsers.htm'
keywords:
  - 複数ブラウザ
  - 並列実行
  - ブラウザ構成
...
- 実行するグリッドのグリッドパラメーターを更新してください。グリッドの設定方法については、[こちら](/docs/integrations/grid-management) をお読みください。

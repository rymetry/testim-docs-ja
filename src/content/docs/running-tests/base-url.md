...
title: ベース URL
description: >-
  テストのベース URL の考え方と、実行時にベース URL をオーバーライドする方法、ベース URL パラメータ BASE_URL
...
:::note{title="ナビゲーションステップの URL がパラメータの場合"}
...
:::note
ベース URL パラメータはパラメータ使用がサポートされている任意の場所で使用できます。詳細については、[パラメータ](/docs/parameters) を参照してください。
:::
...
**ナビゲーションステップにベース URL パラメータを追加するには：**

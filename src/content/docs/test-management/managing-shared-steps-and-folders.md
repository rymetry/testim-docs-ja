...
デフォルトでは、新しい共有ステップはルートフォルダーに配置されます。共有ステップとフォルダーを他のフォルダーに移動できます。\
...
共有ステップライブラリ画面でフォルダーの名前を変更できます。\
:fa-arrow-right: **フォルダーの名前を変更するには:**
...
4. **OK**をクリックします。\
   名前が変更されたファイルまたはフォルダーが共有ステップライブラリに表示されます。

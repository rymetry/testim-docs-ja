...
レビュー担当者が PR を送り返した場合、リクエストに応答して PR を再送信できます。レビュー担当者が競合のために PR を送り返した場合は、[マージのチェリーピック](/docs/testops/testops-version-control/merging-branches#マージのチェリーピック)で説明されているように、競合を確認して解決できます。完了したら、以下の説明に従ってプルリクエストを再送信します。

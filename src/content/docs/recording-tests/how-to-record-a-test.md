...
| --------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Name                              | 構成の名前。                                                                                                                                                                                                                                                                                                            |
| Browser                           | テストを実行するブラウザ。Chrome、Firefox、Safari、Edge Chromium に対応しています。安定版ブラウザのみサポートしており、ベータ版や開発者向け先行配信版（Beta や Dev などのリリースチャンネル）はサポート対象外です。                                                                                                     |

...
5. 関連するステップの**スクリーンショットを表示**ボタンをクリックします。\
   スクリーンショット画面が表示され、ベースラインとテスト結果のスクリーンショットが並んで比較されます。テストが最後に記録されたときに撮影されたベースラインスクリーンショットを確認し、テストが最後に実行されて失敗したときに撮影された結果スクリーンショットと比較します。Testim はエラーの原因となったターゲット要素を強調表示します。

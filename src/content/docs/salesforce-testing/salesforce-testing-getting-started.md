---
title: Salesforce テストの開始
description: Salesforce 環境の接続から、テストの作成・保存・実行までを一連で体験できるチュートリアルです。
...
:::note
この画面には、ブラウザのツールバーにある Testim アイコンをクリックするか、[https://app.testim.io/](https://app.testim.io/)にアクセスすることで、いつでもアクセスできます。
:::

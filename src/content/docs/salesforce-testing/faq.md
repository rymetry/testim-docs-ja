...
テストケースに Salesforce のテストが含まれている限り、他のウェブサイト、他のアプリケーション、および外部 API をまたいでテストできます。詳細については、以下を参照してください。

[Salesforce テストの作成](/docs/salesforce-testing/create-a-salesforce-test)

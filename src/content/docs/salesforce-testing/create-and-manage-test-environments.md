...
description: '原文: https://help.testim.io/docs/create-and-manage-test-environments'
...
* 再接続 - Salesforceステップに問題がある場合、環境のタイプ（Production/Sandbox）を選択し、Connectをクリックしてから、Salesforceアカウントにログインすることで、接続されたテスト環境を再接続できます。

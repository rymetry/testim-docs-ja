...
Testim のアクセシビリティステップは、業界をリードするアクセシビリティライブラリの 1 つである [Deque 社の Axe Core](https://www.deque.com/axe/) を使用しています。アクセシビリティステップ内で検出される違反はアプリケーションコードに起因することが多いため、これらの個別問題への対処は Testim サポートの範囲外です。コード修正によるアクセシビリティ違反の是正で課題がある場合は、[Deque Axe-Core](https://www.deque.com/axe/) の issues ページで相談することをお勧めします。アクセシビリティの専門家から、問題解決のためのガイダンスや解決策を得られます。
:::

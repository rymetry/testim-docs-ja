...
1.name: Sequelize, type: Package, value: [sequelize@latest](https://www.npmjs.com/package/sequelize)<br />
2.name: mysql2, type: Package, value: [mysql2@latest](https://www.npmjs.com/package/mysql2)<br />

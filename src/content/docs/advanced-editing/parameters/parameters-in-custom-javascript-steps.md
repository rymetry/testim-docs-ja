...
JS パラメーターは、定数や変数としてよく使います。グループや再利用ステップへ値を渡す用途が中心です。使用例は[グループのパラメーター](/docs/advanced-editing/parameters/parameters-for-groups)を参照してください。**JS パラメーターを追加するには:**

...
![1897](/images/security-sso/okta-sso-integration/cc7a2ac-image.png)

4. **'SAML 2.0**オプションを選択します。

![955](/images/security-sso/okta-sso-integration/f4ab0a3-Capture1.PNG)

5. **Next**をクリックします。\
   **General Settings**画面が表示されます。

![1152](/images/security-sso/okta-sso-integration/cf9a206-Capture2.PNG)
...
![285](/images/security-sso/okta-sso-integration/713786e-sso1.png)
...
![558](/images/security-sso/okta-sso-integration/f75d3f1-sso4.png)

13. **Okta**を開いているタブに戻り、コピーした**Assertion Consumer Service URL**を**Single sign on URL**フィールドに貼り付けます。

![1128](/images/security-sso/okta-sso-integration/7ecca0b-okta5.png)
...
![762](/images/security-sso/okta-sso-integration/5dae2c9-okta6.PNG)
...
![1200](/images/security-sso/okta-sso-integration/4bb986b-okta7.PNG)
...
![1042](/images/security-sso/okta-sso-integration/8b9736c-image_1.png)

26. 右クリックして「名前を付けて保存」を選択します。
27. **Testim**タブに戻り、**Upload File**ボタンをクリックして、保存したばかりの*metadata.xml*ファイルを選択します。

![614](/images/security-sso/okta-sso-integration/31cb870-sso9.png)

28. 同じ画面で、**Enable SSO**トグルを有効にします。

![1336](/images/security-sso/okta-sso-integration/e687b64-sso10.png)

29. すべてのユーザーがOktaを通じてのみログインでき、通常のTestimログインページを通じてログインできないようにするには、**Force users to login via idP**チェックボックスを選択します。

![619](/images/security-sso/okta-sso-integration/1a94a23-sso11.png)
...
![1253](/images/security-sso/okta-sso-integration/508e2c1-tempsnip1.png)

...
![SAML Test Connector選択画面](/images/security-sso/onelogin-sso-integration/cc41ee8-sso3.png)
...
![OneLogin Configuration設定](/images/security-sso/onelogin-sso-integration/142378a-sso5.png)
...
![パラメータ追加フォーム](/images/security-sso/onelogin-sso-integration/ab6ffb7-sso6.png)
...
![SSO設定ファイルアップロード](/images/security-sso/onelogin-sso-integration/201fcf1-sso8.png)
...
![SSO有効化トグル](/images/security-sso/onelogin-sso-integration/e687b64-sso10.png)

31. すべてのユーザーがOneLoginを通じてのみログインでき、通常のTestimログインページを通じてログインできないようにするには、**Force users to login via idP**チェックボックスを選択します。

![IdP経由ログイン強制チェックボックス](/images/security-sso/onelogin-sso-integration/1a94a23-sso11.png)

...
1. ステップを構成する際、**オブジェクト**と**レコードタイプ**を選択した後、**ページレイアウト**ドロップダウンメニューで以下のいずれかを選択します:
   1. **すべてのフィールド** - Salesforce 動的フォームの場合、このオプションはページレイアウトの一部ではないフィールドも含め、オブジェクトレコードのすべての可能なフィールドを表示します。
   2. **ページレイアウト** - このオプションの下で、 Salesforce で構成されている利用可能なページレイアウトの 1 つを選択します。

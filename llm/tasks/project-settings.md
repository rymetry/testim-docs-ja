...
The default test configuration is the configuration that is used when creating new tests. You can choose on of the test configurations available in the Configuration List. For more info, see [Configuration List](/docs/test-management/shared-configuration).
...
Testim’s auto-complete feature offers you the option to automatically use previously recorded shared group steps in the test you are currently recording, helping you expedite the test recording process. To read more about auto-complete, see [Auto complete](/docs/groups/auto-complete).
...
This setting prevents writing directly to the Master branch and/or to selected branch/es (read-only). If you have selected the Master branch, you can still allow the [Auto-improve](/docs/test-management/locators-auto-improve) changes to automatically improve the test locators in order to enhance the stability of the test.

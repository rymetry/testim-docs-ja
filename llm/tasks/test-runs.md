...
To learn more about saving this filtered view, see [Saving a Filtered View](/docs/test-management/saving-a-filtered-view).
...
Click the **Tag Test Failure** button to tag all the failed runs in the list below with failure types . To learn more - see [Tagging failed runs with failure types](/docs/results/tag-remote-runs-failures)
...
<Table align={["left","left","left"]}>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        The failure tag that was added to the run. To add a Failure Tag, click the "Tag test failure" link. Lear more - [Tagging failed runs with failure types](/docs/results/tag-remote-runs-failures)
      </td>

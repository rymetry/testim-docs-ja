...
3. Set the Custom Script with the appropriate parameters, as described in the [CLI page](/docs/running-tests/the-command-line-cli).\
...
2. For the grid name, read [here](/docs/grid-management/grid-management) how to set up your grid.

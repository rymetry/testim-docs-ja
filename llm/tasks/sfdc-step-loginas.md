...
2. Do one of the following:
   ...
   1. If you want to select a **Persona** that has been already defined through the [Creating a persona](/docs/salesforce-testing/create-a-persona-and-add-users) process, select the desired persona from the **Select persona** drop-down menu.
   2. If you want to use a username that has not been defined as a persona, in the **Input Username** field, enter the user name by doing one of the following:
      ...
      2. **Username variable** - You can also enter JavaScript code and use a variable for the username so that each execution of the test will use a unique username from the test data. Click the **T** icon and enter a JS code. See  [Data-driven testing](/docs/data-driven-testing/data-driven-testing) to learn more.

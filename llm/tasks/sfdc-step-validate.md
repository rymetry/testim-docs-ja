...
>
> The step itself does not navigate to the record, so you will need the system to navigate to the specific record during the execution of a test, so that the designated step will be performed when the record is displayed on Salesforce. To learn more, see [Find and display a specific Salesforce record during test execution](/docs/salesforce-utilities/methods-for-displaying-a-specific-record-during-test-execution).

<br />

:fa-arrow-right:**To add a Validate step:**

1. In your test, add a step before the validate step that will navigate to the desired record. To learn more, see [Find and display a specific Salesforce record during test execution](/docs/salesforce-utilities/methods-for-displaying-a-specific-record-during-test-execution).

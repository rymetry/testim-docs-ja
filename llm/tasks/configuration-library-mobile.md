# 翻訳タスク (configuration-library-mobile)
...
3. Under **Choose a grid**, select a grid from the drop-down menu. If you don't see your desired grid, you may need to add your grid to Testim, See [Grid management](/docs/grid-management/grid-management) for more information.
...
9. In the **Before/After hooks** section, modify the settings as desired. For more information, see [Hooks](/docs/advanced-features/hooks).\

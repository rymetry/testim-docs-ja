...
1. In **Sealights**, go to **Settings > Agent Tokens** and click **Create new token**.  
   ...
   ![](/images/other-integrations/sealights-integration/d94ca5f-sealights2.png)
...
3. Copy the newly created token by clicking the **Copy** button under **Actions**.
   ...
   ![](/images/other-integrations/sealights-integration/9eb0aac-sealights4.png)
4. In Testim, go to **Settings > Integration > Test Optimization** tab.
5. Click **login**.

   ![](/images/other-integrations/sealights-integration/9f2f531-sealightsintegrationslogin.png)
...
In Testim, run the test(s) using the [Command line interface (CLI)](/docs/running-tests/the-command-line-cli), while adding the following option to the execution:
...
- In Sealights, go to **Cockpit > Live Agents Monitor** - this screen displays all the running processes that are instrumented in Sealights. Some of these processes will include an assigned labId as showed below:
  ...
  ![](/images/other-integrations/sealights-integration/319a904-sealights6.png)
...
If you want to use a custom test stage name, you can use the [Command line interface (CLI)](/docs/running-tests/the-command-line-cli) while adding the following option to the execution:
...
1. In Sealights, obtain the Lab ID, by following the instructions in the [labId option](doc:sealights-integration-copy#labid-option) section.
2. In Testim, configure the Scheduler, by following the instructions in the [Scheduler - Web](/docs/running-tests/scheduler) section.
...
5. Optionally, if you use custom Test stage name, enter it in the **Test stage name field**
   ...
   ![](/images/other-integrations/sealights-integration/bc18e30-image_12.png)
...
![](/images/other-integrations/sealights-integration/3a2008c-testlistwith_skipped.png)

## Viewing the Executed List in the Testim UI

In the [Execution Runs Screen](/docs/results/execution-runs-screen), you can view the executed tests list. Under the Status column, you will see an indicator of tests that the test was excluded by Test Optimization.

![](/images/other-integrations/sealights-integration/86c6509-testlistui.png)

Hovering over the **i** icon reveals a notice that the test was excluded by Sealights.

![](/images/other-integrations/sealights-integration/d4a8e26-excludedbysealights.png)

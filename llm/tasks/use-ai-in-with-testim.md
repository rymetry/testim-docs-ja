...
Testim には、あなたの仕事をより簡単にするために設計された方法で、AI を統合しています。Testim が提供する AI ツールをご覧になり、テストの高速化や最も技術的な質問への回答をどのように得られるかを学んでください。
...
テストを高速化し、テストプロセスの単調な部分を排除したいですか？生成 AI 技術と高度な Salesforce 事前構築済みステップを使用して、Salesforce 環境で独自のテストを作成および実行するには、Agentic Test Automation for Salesforce を使用します。

# 翻訳タスク (generate-random-data-with-js)
...
**You can also assign variables if you defined them as[parameters](/docs/parameters/parameters):**
...
- Exporting a value from the custom JS step into the containing group, e.g. add exports.myVar = "testim"; to your JS step.This will create the variable named "myVar" in the scope of the parent (containing) group. You can see an example in the [export parameters doc](/docs/parameters/exports-parameters) (follow this link and search for exports.bestTestingTool = "Testim").

## Learn more

- [Parameters](/docs/parameters/parameters)
- [Data Driven Testing](/docs/data-driven-testing/data-driven-testing)

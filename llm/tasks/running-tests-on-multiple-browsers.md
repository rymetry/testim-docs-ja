# 翻訳タスク (running-tests-on-multiple-browsers)
...
To run your tests on multiple browsers, you will need to run them using CLI or using [Scheduler](/docs/running-tests/scheduler) instead of using the Testim Editor. In this article we will focus on running using CLI, see how it's done.
...
In this section, we will focus only on what you need to add to the CLI to run on different browsers. You can read here about how to use [CLI](/docs/running-tests/the-command-line-cli).
...
- Update the grid parameter of the grid you want to run. Read [here](/docs/grid-management/grid-management) how to set up your grid.

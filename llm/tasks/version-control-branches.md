# 翻訳タスク (version-control-branches)
...
- At a certain point you may want to merge between branches (e.g. merging a feature branch into the Master branch). To perform the merge, follow the instructions in the [Merging Branches](/docs/testops-version-control/merging-branches) section. When you merge your (product) code, you should also merge your testing code. After the merge, consider [deleting the branch](doc:version-control-branches#section-deleting-a-branch) .

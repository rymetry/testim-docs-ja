# 翻訳タスク (mocking-all-the-network-traffic-using-a-har-file)
...
1. After saving your test (See [How to Record a Test](/docs/recording-tests/how-to-record-a-test)), click the Properties (:fa-cog:) icon. The **Test Properties** pane is displayed:

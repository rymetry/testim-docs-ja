# 翻訳タスク (dependencies-and-ordering-of-tests)
...
Read more about Test Plans and how to use it [here](/docs/test-management/test-plans).
...
You can read more on Configuration Files [here](/docs/configuration-file/configuration-file-run-hooks).\
If you need to pass a parameter from the configuration file to your test you can read about it [here](/docs/parameters-for-tests).
...
1. **Test Suite** - you can create a Test suite where you can set the order in which you want to run the tests. Read more about Test suites [here](/docs/test-management/test-suites).

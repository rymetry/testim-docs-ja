# 翻訳タスク (salesforce-testing-getting-started)
...
1. In your Testim for Salesforce account, go to **Settings > Salesforce > Environments** and select **Connect a salesforce environment**.\
   ![](/images/salesforce-testing/salesforce-testing-getting-started/681f2b6-connect.png)
...
5. Click **Connect**.\
   ...
   ![](/images/salesforce-testing/salesforce-testing-getting-started/43f1fac-salesforcelogin.png)
...
1. Click on **New Test**.
   ...
   ![](/images/salesforce-testing/salesforce-testing-getting-started/d3dd794-newtest.png)
...
2. The first step is the Setup step, where the basic test configuration is set. In the **Setup** step, click the **Show properties** button.
   ...
   ![](/images/salesforce-testing/salesforce-testing-getting-started/9dc1f8d-showproperties.png)

   The **Properties** pane is displayed.

   ![](/images/salesforce-testing/salesforce-testing-getting-started/03e8e96-propeties_pane.png)
...
5. Under the **Salesforce steps** tab, click the **Log in** step. This step logs in to the Salesforce environment using the selected persona/user.
   ...
   ![](/images/salesforce-testing/salesforce-testing-getting-started/398d8d3-login.png)
...
9. In the step's **Object** pane, under **Select App**, select the **Sales** option.
   ...
   ![](/images/salesforce-testing/salesforce-testing-getting-started/0dbd17f-salesapp.png)
...
13. If the **Select Record Type** field is displayed (dependent on your environment's configuration), select any of the available options.\
    ...
    ![](/images/salesforce-testing/salesforce-testing-getting-started/d6e7105-createv2.png)
...
![](/images/salesforce-testing/salesforce-testing-getting-started/9c85234-Image_007.png)
...
1. On the Editor screen, click on the **Run** button.
   ...
   ![](/images/salesforce-testing/salesforce-testing-getting-started/334dca8-runbutton.png)
...
![](/images/salesforce-testing/salesforce-testing-getting-started/9f21ed2-Image_017.png)
...
![](/images/salesforce-testing/salesforce-testing-getting-started/f932812-Run_without_errors.png)
...
![](/images/salesforce-testing/salesforce-testing-getting-started/f583aef-viewscreenshot.png)
...
![](/images/salesforce-testing/salesforce-testing-getting-started/940cc27-screenshot.png)
...
![](/images/salesforce-testing/salesforce-testing-getting-started/424d937-failedtest.png)

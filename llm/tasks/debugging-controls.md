  ...
  <tbody>
    <tr>
      ...
      <td style={{ textAlign: "left" }}>
        ...
        • [Play from here](/docs/test-execution/play-from-here)\
        • [Rerun locally with the same params](/docs/test-execution/rerun-locally-with-the-same-params)
      </td>

      <td style={{ textAlign: "left" }}>
        • [Start recording](doc:recording-additional-steps-to-fix-bugs#start-recording)\
        • [Start recording at position](doc:recording-additional-steps-to-fix-bugs#start-recording-at-this-position)
      </td>
    </tr>
  </tbody>
</Table>
...
- **Manual breakpoint** - breakpoint set manually by the user (See [Insert a breakpoint](doc:stop-pause-debug-tests#insert-a-breakpoint) for more info)\

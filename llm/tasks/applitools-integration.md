...
8. Click **Connect**.\
   A success icon is shown, and Applitools is integrated with Testim. You can now start using the visual validation and wait-for steps. See [Visual Validation](/docs/validations/pixel-validation-and-pixel-wait-for).

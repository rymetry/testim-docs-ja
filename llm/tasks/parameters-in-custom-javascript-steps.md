# 翻訳タスク (parameters-in-custom-javascript-steps)
...
![](/images/parameters/parameters-in-custom-javascript-steps/f73cb06-function.jpg "function.jpg")

4. **PARAMS** の横の「+」をクリックし、HTML を選択します。

![](/images/parameters/parameters-in-custom-javascript-steps/45bd5ce-selecthtml.jpg "selecthtml.jpg")

5. AUT上で、パラメータを割り当てたい要素を選択します（例: フッターのTwitterアイコン）。

![](/images/parameters/parameters-in-custom-javascript-steps/6e230ca-twittericon.jpg "twittericon.jpg")

選択した要素のスニペットが PARAMS セクションに表示されます。

![](/images/parameters/parameters-in-custom-javascript-steps/fe4964c-snippet.jpg "snippet.jpg")

6. HTML見出し横の名前をダブルクリックして、任意の名前に変更します。

![](/images/parameters/parameters-in-custom-javascript-steps/c719269-name.jpg "name.jpg")
...
![](/images/parameters/parameters-in-custom-javascript-steps/0f78633-sharedsteps.jpg "sharedsteps.jpg")

共有ステップが複製されます。

![](/images/parameters/parameters-in-custom-javascript-steps/ed59427-duplicated.jpg "duplicated.jpg")

2. 新しいステップをダブルクリックして編集します。
3. 既存のパラメータは残っていますが、**Assign HTML** をクリックして別の要素に割り当て直します。

![](/images/parameters/parameters-in-custom-javascript-steps/94de6da-assignhtml.jpg "assignhtml.jpg")

4. 別の要素を選択します（例: フッターの LinkedIn アイコン）。

![](/images/parameters/parameters-in-custom-javascript-steps/8b65e10-linkedin.jpg "linkedin.jpg")

テストを実行すると、両方のボタンがクリックされます。

## プロパティパネルでJSパラメータを追加する

JSパラメータは、定数や変数としてよく使います。グループや再利用ステップへ値を渡す用途が中心です。使用例は[グループのパラメータ](/docs/parameters/parameters-for-groups)を参照してください。

:fa-arrow-right:**JSパラメータを追加するには:**

1. **プロパティパネル**で **Params** 横の **+** をクリックし、**JS** を選択します。

   ![](/images/parameters/parameters-in-custom-javascript-steps/d5ea619-plus.png)
2. **編集**アイコンから名前を変更します（既定の "param" を置き換え）。

   ![](/images/parameters/parameters-in-custom-javascript-steps/96cc4ee-edit.png)
3. 名前の下の欄に値を入力します。文字列はクォートで囲みます（例: 'guest'）。この値はこのテスト内だけで有効です（他テストとは共有されません）。

![](/images/parameters/parameters-in-custom-javascript-steps/898f70a-guest.png)

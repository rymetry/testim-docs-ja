...
> 📘 When you reassign the test owner a test revision is automatically created. For more information, see [Revisions](https://help.testim.io/docs/revisions).

> 📘 Tests can have different owners in different branches. For example: Sample\_Test can have Owner A in the master branch, and Owner B in a different branch. If you merge the branches, you will need to decide which owner to assign to the newly merged test. For more information, see [Version control (branches)](https://help.testim.io/docs/version-control-branches).
...
1. Open a test in the Editor. For more information see [Opening a test](https://help.testim.io/docs/test-list#opening-a-test).
2. Click the **Show step properties** icon to open the **Test Configuration Properties** panel.

![3851](https://files.readme.io/7b99d23-Testim_196a.png "Testim 196a.png")
...
![200](https://files.readme.io/c7347ec-Testim_197a_r.png "Testim 197a_r.png")

The **Replace Test Owner** window is shown.

![300](https://files.readme.io/a0e5978-Testim_194_r.png "Testim 194_r.png")
...
![3851](https://files.readme.io/41cae47-Testim_192.png "Testim 192.png")

2. Select the test (or multiple tests) for which you wish to change the owner.\
   Additional options are shown in the **Top Menu**.

![3851](https://files.readme.io/9237d3f-Testim_193a.png "Testim 193a.png")

3. Click the **Replace owner** icon (or right-click on a test and from the list that is shown choose **Replace owner**).

![3851](https://files.readme.io/b3ad2fa-Testim_193b.png "Testim 193b.png")

The **Replace Test Owner** window is shown.

![300](https://files.readme.io/3419b72-Testim_194_r.png "Testim 194_r.png")

4. Select the new owner and click **Confirm**.\
   The window is closed and the new owner is listed.

![960](https://files.readme.io/617e420-Feb-08-2021_08-56-14.gif "Feb-08-2021 08-56-14.gif")
...
![3851](https://files.readme.io/2ccd6df-Testim_192a.png "Testim 192a.png")

The **Filter Test** pane opens on the right-hand side.

![200](https://files.readme.io/ebac246-Testim_195_r.png "Testim 195_r.png")
...
![3832](https://files.readme.io/911a46f-Testim_198.png "Testim 198.png")
...
![3851](https://files.readme.io/a1519d8-Testim_199a.png "Testim 199a.png")
...
![3851](https://files.readme.io/257c1eb-Testim_200a.png "Testim 200a.png")

The filtered list is shown.

![1210](https://files.readme.io/09fd471-Feb-09-2021_05-50-07.gif "Feb-09-2021 05-50-07.gif")
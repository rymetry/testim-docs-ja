...
Validate viewport visualization allows you to compare the visual difference between your baseline and your current test run of your viewport. This functionality is provided as a service by [Applitools](https://applitools.com), and requires integration with their Applitools Eyes app. For more information see [Visual Validation (element, viewport, full-page)](https://help.testim.io/docs/pixel-validation-and-pixel-wait-for).
...
:fa-arrow-right: **To add a Validate viewport visualization or Validate full-page visualization step:**
...
4. Scroll down through the menu and select **Validate viewport visualization**.
...
> 📘 You can also use keyboard shortcuts to add a **Validate viewport visualization** step. See [Keyboard shortcuts](https://help.testim.io/docs/keyboard-shortcuts).
...
> 🚧 Before using pull requests you need to enable and configure the pull request settings in the **Project settings**. For more information, see [Project settings](https://help.testim.io/docs/project-settings#pull-request-settings).
...
To learn more about resolving conflicts, see [Resolving Conflicts](https://help.testim.io/docs/merging-branches#section-resolving-conflicts).

### Issuing a Pull Request

:fa-arrow-right: **To create a pull request:**

![640](https://files.readme.io/99a18df-Open.gif "Open.gif")
...
![1920](https://files.readme.io/be05e3d-prreview2.gif "prreview2.gif")
...
* **Comments** – click the comments icon to view the comment history. &lt;add screenshot of the PR list&gt;
  ...
  Closed PRs can be viewed directly in the [audit log](https://help.testim.io/docs/audit-log). When deleting a branch, the PR will automatically be closed.
...
![429](https://files.readme.io/876fb0e-Testim_621.png "Testim 621.png")
...
If the reviewer sent back the PR, you can respond to the request and resubmit the PR. If the reviewer sent back the PR due to conflicts, you can review and resolve the conflicts as described in [Resolving Conflicts](https://help.testim.io/docs/merging-branches#section-resolving-conflicts). When done, resubmit the pull request as described below.

:fa-arrow-right: **To resubmit a pull request:**

![640](https://files.readme.io/7035af3-PR3.gif "PR3.gif")
...
![400](https://files.readme.io/325f07e-Testim_613_r.png "Testim 613_r.png")

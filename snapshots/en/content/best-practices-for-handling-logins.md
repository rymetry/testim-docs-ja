...
If this is your first test, use this [guide](https://help.testim.io/docs/hello-world) to help you.

![1903](https://files.readme.io/546ac11-login_1.gif "login_1.gif")
...
Learn here how to run in an incognito mode [here](https://help.testim.io/docs/run-in-incognito).

### Group your steps

Grouping your login steps will allow reuse of these steps for the other tests.\
Learn how to group your login steps [here](https://help.testim.io/docs/groups).

Note: Make sure you give your group a meaningful name.

![640](https://files.readme.io/4dfa1e2-Oct-20-2020_11-42-25.gif "Oct-20-2020 11-42-25.gif")
...
![640](https://files.readme.io/535c34a-Oct-20-2020_11-47-18.gif "Oct-20-2020 11-47-18.gif")

Learn about how to add [conditions](https://help.testim.io/docs/conditions).
...
![640](https://files.readme.io/cfbed43-Oct-20-2020_11-51-43.gif "Oct-20-2020 11-51-43.gif")

Learn more about adding [parameters to a group](https://help.testim.io/docs/parameters-for-groups).
...
1. Clear unnecessary steps. [Learn more](https://help.testim.io/docs/editing-your-tests) on how to delete steps.

...
* [Pull Requests](https://help.testim.io/docs/pull-requests): A pull request (PR) is a feature of Testim version control that allows test developers to propose changes to a main branch (usually 'master’).
  * The PR mechanism is active when merging to any [branch with a read only indication](https://help.testim.io/docs/read-only).

...
<Image align="center" src="https://files.readme.io/bb1af3f-schedulermobile1.png" />

3. Under **General Information**, enter a **Name** for the scheduler and optionally a **Description**.

<Image align="center" src="https://files.readme.io/38ac724-schedulermobile2.png" />
...
5. Under **Where to run**, select the mobile grid you would like to execute your tests on. For more information about grid configuration, see [Grid management](https://help.testim.io/docs/grid-management).
...
10. Click **Advanced** to configure [Advanced scheduler options](https://help.testim.io/docs/scheduler#section-advanced-scheduler-options).

    <Image align="center" src="https://files.readme.io/1b576ad-scheduler3.png" />
...
![](https://files.readme.io/62cade7-Screen_Shot_2020-09-06_at_15.21.32.png "Screen_Shot_2020-09-06_at_15.21.32.png")
...
* **Branch** - if you do not was to run the test on the master branch, select the another branch to run on. See [Version control (branches)](https://help.testim.io/docs/version-control-branches) for more information.
...
<Image align="center" src="https://files.readme.io/0ec2157-activateschedule.png" />
...
![](https://files.readme.io/c227da0-applyfiltersscheduler.png "applyfiltersscheduler.png")

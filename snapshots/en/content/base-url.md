...
![](https://files.readme.io/b1cff8e-baseurl.jpg)
...
![](https://files.readme.io/3bcd12f-runongrid.jpg)

In addition, here's a list of components you can use to send a different base URL while running the test:

* [CLI](https://help.testim.io/docs/the-command-line-cli)
* [Scheduler](https://help.testim.io/docs/scheduler)
* [Configuration File](https://help.testim.io/docs/configuration-file-run-hooks)
...
![](https://files.readme.io/2907735-fb0b21d-base-url-setup.jpg)
...
![](https://files.readme.io/6e073c9-image.png)
...
For more information about data-driven tests, see [Data-driven testing](https://help.testim.io/docs/data-driven-testing)

> 📘
>
> The Base URL parameter can be used wherever parameter usage is supported. For more information, see [Parameters](https://help.testim.io/docs/parameters).
...
1. Hover over the **+** or **Arrow** icon where you want to add a new **Custom Action Step** and click the **Testim predefined steps** button.\
   ![](https://files.readme.io/45c6324-2023-06-13_17-20-26.jpg)
...
4. In the **Name** the new step field, enter a (meaningful) name for this step.\
   ![](https://files.readme.io/e352510-2023-06-13_17-23-03.jpg)
5. Click **Create Step**.\
...
![](https://files.readme.io/09475a3-2023-06-13_17-28-39.jpg)
...
![](https://files.readme.io/0fa605c-predefined.jpg "predefined.jpg")

2. Search for **Add navigation action** and click it.

![](https://files.readme.io/10e28bf-nav-step.jpg "nav-step.jpg")

3. Input the URL using the **BASE\_URL** parameter, followed by remaining URL path.

![](https://files.readme.io/0017136-nav-url.jpg "nav-url.jpg")
...
![](https://files.readme.io/d14049f-base-url.jpg "base-url.jpg")
